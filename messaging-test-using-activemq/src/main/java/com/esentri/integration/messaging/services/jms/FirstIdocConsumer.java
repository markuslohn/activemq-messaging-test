...
/** Accepts all messages from the queue. */
@ApplicationScoped
@Log
public final class FirstIdocConsumer implements Runnable {

  @ConfigProperty(name = "message.idoc.consumer1.queue.name")
  private String queueName;

  @ConfigProperty(name = "message.idoc.consumer1.queue.enable", defaultValue = "true")
  ...
  public FirstIdocConsumer(ConnectionFactory connectionFactory) {
